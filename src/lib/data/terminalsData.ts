export const readMore = {
  creeper: `
<div>
<h2 style="font-size: 2.5rem; font-weight: 500; margin-bottom: 1rem"># Legado</h2>
<ul style="list-style-type: disc; list-style: auto; margin-left: 2.5rem; display: grid; gap: 1rem">
<li>
Pioneirismo: O Creeper marcou o início da era dos vírus de computador, inspirando o desenvolvimento de softwares antivírus e novas técnicas de segurança.
</li>
<li>
Evolução: Apesar de sua simplicidade, o Creeper lançou as bases para os vírus mais complexos que surgiriam nas décadas seguintes.
</li>
<li>
Conscientização: O experimento serviu como um alerta sobre os riscos da segurança cibernética e a importância da proteção de dados em um mundo cada vez mais digitalizado.
</li>
</ul>
</div>
`,
...
Motivados pela pirataria desenfreada de software em sua loja de computadores em Lahore, Paquistão, os irmãos Alvi buscaram uma solução radical. O Brain nasceu como uma retaliação contra os clientes que copiavam ilegalmente seus programas. O vírus, cuidadosamente inserido no setor de boot dos disquetes, tinha um objetivo peculiar: alertar os usuários sobre a pirataria e dissuadi-los de práticas antiéticas.
</p>
<p style="font-size: 1.75rem; margin-bottom: 0.5rem">
O Brain operava de forma furtiva, explorando uma falha crucial na segurança dos computadores da época. Ao se esconder no setor de boot, o vírus se tornava parte essencial do processo de inicialização do sistema. Quando um disquete infectado era inserido em um computador, o Brain aproveitava a oportunidade para se replicar, infectando automaticamente o setor de boot do disco rígido.
</p>
<p style="font-size: 1.75rem; margin-bottom: 0.5rem">
A cada inicialização subsequente, o Brain entrava em ação. Ele substituía o setor de boot original por sua própria cópia, garantindo sua persistência no sistema. Em seguida, exibia uma mensagem na tela, informando o usuário sobre a presença do vírus e contendo os contatos dos irmãos Alvi. A mensagem, embora incomum, demonstrava a intenção inicial dos criadores: alertar, não destruir.
Apesar das boas intenções, o Brain se espalhou rapidamente além do controle de seus criadores. Através da troca de disquetes infectados, o vírus alcançou diversos países, causando transtornos e perplexidade entre os usuários de computadores. A ausência de conhecimento sobre vírus na época amplificava o impacto do Brain, gerando medo e insegurança.
</p>
<p style="font-size: 1.75rem; margin-bottom: 0.5rem">
O Brain, apesar de sua natureza rudimentar para os padrões atuais, representou um ponto de inflexão na história da segurança cibernética. Ele demonstrou o potencial destrutivo de softwares mal-intencionados e a necessidade urgente de medidas de proteção. A partir do Brain, a indústria de antivírus floresceu, e práticas de segurança rigorosas se tornaram essenciais para o uso seguro de computadores.
</p>
<p style="font-size: 1.75rem; margin-bottom: 0.5rem">
O Vírus Brain, embora controverso em suas origens, serve como um lembrete crucial da importância da ética no uso de software e da necessidade constante de vigilância contra ameaças cibernéticas. Sua história, repleta de inovação e consequências inesperadas, nos convida a refletir sobre o poder da tecnologia e a responsabilidade que acompanha seu uso.
</p>
</div>
`,
  jerusalem: `
...
A escolha da data para uma sexta-feira 13, tem um valor que podemos considerar até supersticioso, já que é uma data onde as pessoas buscam evitar alguns acontecimentos para evitar azares e situações ruins, onde podia ser umas deles ter os arquivos do seu computador deletado, por isso, algumas pessoas que tinham medo desse vírus, tinham o costume de alterar a data para uma dia na frente para evitar a ativação do possível vírus.
</p>
<p style="font-size: 1.75rem; margin-bottom: 0.5rem">
Assim como muitos dos malwares criados nessa época, o autor ou o grupo autor nunca foi identificado, pois muitos desses gostavam de fazer as coisas no anonimato, e independente disso o vírus chamou a atenção para os vírus do tipo bomba relógio, sendo necessário aprimorar as medidas de defesas e de detecção para combater vírus que podem ficar hibernando no computador esperando por um momento oportuno.
</p>
</div>
`,
  melissa: `
<div>
<p style="font-size: 1.75rem; margin-bottom: 1rem">
Melissa foi um vírus, que infecta arquivos do tipo  MS Word, onde na época eram o  Word 8 e Word 9 ( do pacote Office 97 e do Office 2000 respectivamente), onde nesse arquivo doc era embutido o macro do malware Melissa. O Melissa foi um malware que foi propagado por meio de envios de emails, onde esse email geralmente tinha um título apelativo, de caráter importante, que sugeriam que a vítima clicasse para abrir o documento, assim disparando o macro. O malware geralmente tinha um mensagem parecida com “Aqui está o documento que você pediu… não mostre para mais ninguém ;-) ”
</p>
<p style="font-size: 1.75rem; margin-bottom: 1rem">
Assim que a vítima recebia o email e clicava no documento,  o macro era executado, onde as tarefas determinadas faziam com que o malware detectasse se na lista de endereços de email da vitima tinham 50 endereços, se tivesse até 50 endereços, todos esses endereços recebiam uma cópia desse email com o malware melissa, caso o usuário tivesse mais de 50 endereços de email, o malware apenas mandava para os últimos endereços utilizados, onde esses emails eram enviados somente até 50 pessoas, para não ser pego pelo filtro anti-spam, e o email ser esquecido na caixa de spam.
</p>
<p style="font-size: 1.75rem; margin-bottom: 1rem">
O malware Melissa teve um grande impacto, levando a um alto prejuízo em pouco tempo, onde nesse tempo a produtividade foi severamente congestionada, fazendo com que grandes recursos tivessem que ser movidos para limpar as áreas infectadas e implementar medidas de seguranças contra ataques semelhantes, isso sem contar pelo prejuizo do periodo inoperante.
</p>
<p style="font-size: 1.75rem; margin-bottom: 1rem">
O autor do vírus foi identificado e assumiu a culpa, onde foi levado preso para pagar pelos seus danos. Embora todos esses acontecimentos, Melissa foi um vírus que além de expor e alertar uma vulnerabilidade de um programa, também mostra a necessidade de uma bom desenvolvimento e atenção na hora de se criar um software, onde todos os tipos de exploits devem ser ao máximo corrigidos. Além disso, Melissa também impulsionou um cuidado em lidar também com malwares do tipo worms, ainda mais com um meio tão fácil de propagação como a internet.
</p>
</div>
`,
  bonzibuddy: `
<div>
<p style="font-size: 1.75rem; margin-bottom: 1rem">
Em uma época onde a internet ainda engatinhava e a ingenuidade reinava suprema, o BonziBuddy surgiu como um salvador digital, um assistente virtual pronto para tornar a vida dos usuários de Windows mais fácil e divertida. Mas por trás da fachada amigável e dos sorrisos vibrantes de seu simpático mascote, um monstro se escondia: um spyware e adware que espionava seus dados e bombardeava você com propagandas indesejadas.
O ano era 1999. A internet ainda era uma novidade para muitos, e o Windows 98 reinava supremo nos desktops. Foi nesse cenário que Joe e Jay Bonzi, dois irmãos programadores, criaram o BonziBuddy.
</p>
<p style="font-size: 1.75rem; margin-bottom: 1rem">
O software se apresentava como um assistente virtual, prometendo ajudar os usuários com diversas tarefas: gerenciar downloads, compartilhar curiosidades e fatos aleatórios, cantar músicas e até mesmo oferecer um ombro amigo virtual.Para atrair os usuários, os Bonzi criaram um personagem carismático: um coelho animado chamado Bonzi. Com seus olhos grandes e sorriso contagiante, Bonzi rapidamente conquistou o coração de muitos, especialmente crianças e adolescentes. O software se tornou um sucesso instantâneo, baixado por milhões de usuários em todo o mundo.
Mas nem tudo que reluz é ouro.
</p>
<p style="font-size: 1.75rem; margin-bottom: 1rem">
Usuários começaram a desinstalar o software em massa, e a empresa por trás do BonziBuddy enfrentou diversos processos judiciais.Em 2004, a empresa por trás do BonziBuddy foi obrigada a pagar multas por suas práticas antiéticas. O software foi descontinuado e seu site oficial foi fechado. A história do BonziBuddy serve como um lembrete importante da importância da vigilância cibernética e da necessidade de estarmos atentos aos softwares que instalamos em nossos computadores
</p>
</div>
`,
  chernobyl: `
...
<ol style="list-style-type: decimal!important; list-style: auto!important; margin-left: 2.5rem; display: grid; gap: 1rem">
<li>
